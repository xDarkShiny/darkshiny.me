...
<body class="bg-black p-2 ">

<div class="min-h-screen  space-y-5  columns-4xl items-start ">
    <div  class="2xl:flex  sm:space-x-5 xl:space-y-6 rounded-3xl  justify-center text-center items-center background-color p-3">
        <img class="2xl:mb-4 mb-0 justify-center p-1 w-full 2xl:w-72 rounded-full drop-shadow-sm shadow-emerald-500" src="https://cdn.discordapp.com/avatars/438037153310834700/<?php echo $json->data->discord_user->avatar ?>.png?size=4096">
        <div class="flex flex-col space-y-3">
            <a class="sm:text-5xl text-3xl text-style text-white/90 font-bold">Hi I`m <span class="text-green-500"><?php echo $json->data->discord_user->username; ?></span>.👋</a>
    ...
    <div class="flex  flex-col space-y-3 background-color rounded-3xl justify-start p-10">
        <h1 class="text-white text-style text-4xl font-bold">PLAYİNG A GAME</h1>
        <div class="flex flex-col sm:flex-row sm:justify-start justify-center items-center space-y-4 space-x-4">
            ...
            <div class="flex flex-col  h-32">
                    <img class="w-32 rounded-3xl h-32" src="https://cdn.discordapp.com/app-assets/'.$json->data->activities[1]->application_id.'/'.$json->data->activities[1]->assets->large_image.'.png">
                </div>
                <div>
