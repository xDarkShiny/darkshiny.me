        ...
        <div className="flex md:flex-row flex-col items-center justify-self-start xl:space-x-[300px] xl:space-y-0 space-y-5  ">
                <div className="mt-12 md:ml-10 ml-2 px-2 md:px-0">
                    ...
                    <div className="flex mt-2 space-x-5">
                        <a target='_blank' href="https://discord.com/users/894637264259387402" className="flex w-14 h-14 items-center justify-center rounded-xl bg-[#252525] transition-all ease-in-out duration-300 hover:scale-95"><img className="w-8" src={Discord} alt="discord"/></a>
                        <a target='_blank' href="https://github.com/xDarkShiny" className="flex w-14 h-14 items-center justify-center rounded-xl bg-[#252525] transition-all ease-in-out duration-300 hover:scale-95"><img className="w-8" src={Github} alt="github"/></a>
                    </div>
                    <a href='/projects' className="flex mt-4 rounded-md px-5 uppercase py-3 bg-[#006BFF] w-52 items-center justify-between font-bold text-sm transition-all ease-in-out duration-300 hover:scale-95"><h1>See Projects</h1><img src={arrow} alt="arrow"/></a>
                </div>
            <Lang />
        </div>
    )
