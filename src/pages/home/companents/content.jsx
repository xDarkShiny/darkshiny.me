        ...
        <div className="flex md:flex-row flex-col items-center justify-self-start xl:space-x-[300px] xl:space-y-0 space-y-5  ">
                <div className="mt-12 md:ml-10 ml-2 px-2 md:px-0">
                    ...
                    <div className="flex mt-2 space-x-5">
                        <a href="/" className="flex w-14 h-14 items-center justify-center rounded-xl bg-[#252525]"><img className="w-8" src={Discord} alt="discord"/></a>
                        <a href="/" className="flex w-14 h-14 items-center justify-center rounded-xl bg-[#252525]"><img className="w-8" src={Github} alt="discord"/></a>
                    </div>
